...
const INITIAL_LESSONS: LessonRecord[] = [
  ...
  },
  {
    ...
    audio_url: 'https://actions.google.com/sounds/v1/ambiences/rain_heavy.ogg',
    raw_transcript:
      '今天心悅彈徹爾尼 599 第 20 首，右手顆粒感進步很多，手指獨立性非常好。但第 12 小節左手和弦伴奏有點太重了，手腕要放鬆帶動，不要用力往下砸。作業請把第 20 首以 BPM 80 速度練習，加上巴哈初步第 3 首前四小節雙手分開慢練。加油！',
    clean_summary_json: {
      highlights: [
    ...
    created_at: '2026-09-16T17:30:00+08:00',
