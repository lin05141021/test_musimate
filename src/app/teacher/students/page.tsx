...
// 授課教師：林佩芬 老師 (Piano Master) 名下學生真實資料庫
const DB_STUDENTS_ROSTER: StudentRecord[] = [
  {
    ...
    phone: '0911-222-333',
    parentName: '劉媽媽',
    teacherNote: '徹爾尼 599 顆粒感佳，注意第 12 小節左手伴奏放輕，手腕呼吸自然。',
    recentPiece: '徹爾尼 599 第 20 首 & 巴哈初步第 3 首',
  ...
  },
  {
    ...
    statusText: '上課中',
    nextLessonDate: '09/18 (五)',
    nextLessonTime: '17:00',
    location: '音符琴房 A303',
    bookedLessons: 7,
    totalLessons: 10,
    pendingReviews: 1,
  ...
  },
  {
    ...
    phone: '0955-666-777',
    parentName: '陳媽媽',
    teacherNote: '巴哈二聲部對位聲部清晰，注意右手連音與非連音的觸鍵區別。',
    recentPiece: '巴哈：二聲部創意曲 No.1 C大調',
